...
@DisplayName("Тест № 4: Получение данных пользователя")

public class GetProfileInfoTest {
    @Test
    @DisplayName("Получение данных профиля")
    @Description("Ожидаемый результат - данные профиля")
    public void getProfileInfoIsSuccess() {
